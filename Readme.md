# Akkeris Postgres CLI Plugin

An akkeris postgresql plugin for awesome pg:* commands that are also great and fun and super.
...
```
$ aka pg:pull DATABASE localdbname --app myapp
```
```
$ aka pg:push localdbname DATABASE --app myapp
```

```
$ aka pg:total-index-size
  size
-------
 28194 MB
(1 row)
