...
module.exports = {
  init:function (appkit) {
    ...
    appkit.args.command('pg:total-table-size', 'show the size of the tables (including indexes), descending by size', require_options, run.bind(null, appkit))
      .command('pg:total_table_size', false, require_options, run.bind(null, appkit))
  },
  update:function() {},
  'group':'pg',
