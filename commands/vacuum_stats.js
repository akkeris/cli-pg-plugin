...
module.exports = {
  init:function (appkit) {
    ...
    appkit.args.command('pg:vacuum-stats', 'show dead rows and whether an automatic vacuum is expected to be triggered', require_options, run.bind(null, appkit))
      .command('pg:vacuum_stats', false, require_options, run.bind(null, appkit))
  },
  update:function() {},
  'group':'pg',
